...
@:uextern extern class FGatherTextFromMetaDataConfiguration {
  @:uname('new') public static function create():PHaxeCreated<unreal.localization.FGatherTextFromMetaDataConfiguration>;
