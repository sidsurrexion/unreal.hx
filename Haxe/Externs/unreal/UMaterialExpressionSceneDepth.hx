...
@:glueCppIncludes("Materials/MaterialExpressionSceneDepth.h", "Engine.h")
@:uextern extern class UMaterialExpressionSceneDepth extends unreal.UMaterialExpression {
